@php
    ...
    $intro = 'A newsletter or quick signup form was submitted.';
@endphp
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <tr>
                        <td style="padding: 28px 36px 28px;">
                            <div style="border: 1px solid #dbe8f8; border-radius: 18px; overflow: hidden;">
                                <div style="padding: 14px 18px; background-color: #eff6ff; border-bottom: 1px solid #dbe8f8; font-size: 13px; font-weight: 700; letter-spacing: 0.8px; text-transform: uppercase; color: #1174cf;">Subscriber Details</div>
                                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
                                    ...
                                    @if (!empty($fields['name']))
                                        <tr><td valign="top" style="width: 240px; padding: 16px 18px; background-color: #fbfdff; font-size: 14px; font-weight: 700; color: #102746;">Name</td><td valign="top" style="padding: 16px 18px; font-size: 14px; line-height: 1.7; color: #334155;">{{ $fields['name'] }}</td></tr>
                                    @endif
                                </table>
                            </div>
                        </td>
